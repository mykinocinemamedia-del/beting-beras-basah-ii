...
const translations: Record<Language, TranslationDict> = {
  ms: {
    ...
    "pkg.4.note": "Bukan sekadar penajaan. Pembangunan modal insan yang berkekalan untuk pasukan teknikal dan kreatif tuan-tuan.",
    "pkg.4.intro": "8–12 minggu perjalanan sepenuhnya. Lima elemen. Satu kohort bernama rasmi.",
    "pkg.4.section1.label": "5 Elemen Program",
    ...
    "pkg.4.section2.label": "Apa Yang Tuan-tuan Bawa Pulang",
    "pkg.4.f7": "Kohort bernama rasmi (Waris [Syarikat] 2026)",
    "pkg.4.f8": "Modul latihan boleh bawa balik untuk latihan dalaman",
    "pkg.4.f9": "Laporan program lengkap (bilangan peserta, jam, sijil)",
    "pkg.4.f10": "Dokumentasi sedia guna (gambar + video setiap sesi)",
    "pkg.4.f11": "Kredit harta intelek kekal pada modul",
    "pkg.4.f12": "Sijil penyertaan rasmi setiap peserta",
    "pkg.4.f13": "Kelayakan potongan cukai (Perenggan 34(6)(k))",
    "pkg.4.stats.hours": "96–120 jam latihan",
    "pkg.4.stats.students": "20–30 peserta terpilih",
    "pkg.4.stats.weeks": "8–12 minggu program",
    ...
    "prog.problem.typical.3": "Banner dilipat selepas pementasan",
    ...
    "prog.problem.bbb.4": "Bilangan yang membawa perubahan, bukan sekadar kehadiran",
    "prog.problem.bbb.5": "Meninggalkan kesan yang berbekas, bukan sekadar gambar kenangan",
    ...
    "prog.step.4.deliverable": "Bahan CSR sedia guna",
    ...
    "prog.hidden.savings_label": "Tuan-tuan menjimatkan",
    ...
    "prog.hidden.organic.4": "Jangkauan media sosial semula jadi",
    "prog.hidden.note":
    ...
    "prog.board.3.tag": "Bahan Dokumentasi CSR",
    "prog.board.3.desc":
    ...
    "prog.board.5.tag": "Liputan Media Organik",
    "prog.board.5.desc":
    ...
    "prog.calc.intro":
      "Seandainya tuan-tuan ingin membina program seumpama ini dari awal bersama pihak ketiga, inilah anggarannya. Gerak slider untuk lihat perbandingan.",
    "prog.calc.slider_label": "Tahap penajaan yang tuan-tuan pertimbangkan",
    "prog.calc.tier.1": "Saujana",
    "prog.calc.tier.2": "Sinar Warisan",
    "prog.calc.tier.3": "Wira Budaya",
    "prog.calc.cost_breakdown": "Pecahan Kos Sekiranya Dibina Secara Berasingan",
    ...
    "prog.calc.item.3": "Dokumentasi profesional & penerbitan bahan",
    "prog.calc.item.3.cost": "RM 4,000 – 7,000",
    "prog.calc.item.4": "Akses venue bertaraf nasional beserta kelulusan",
    "prog.calc.item.4.cost": "RM 2,000 – 3,000",
    "prog.calc.subtotal_label": "Jumlah asas (sebelum nilai tambah)",
    "prog.calc.extras_label": "Nilai tambah yang tidak boleh didapatkan secara berasingan",
    ...
    "prog.calc.your_investment": "Pelaburan Tuan-tuan",
    "prog.calc.roi": "Nisbah Pulangan Nilai",
    ...
    "prog.journey.deliverable_label": "Hasil:",
    "prog.board.click_hint": "← Klik mana-mana kad di atas untuk lihat butiran",
    "prog.board.empty_hint": "← Klik mana-mana kad di atas untuk lihat butiran",
    "prog.calc.tier_prefix": "Pakej",
    "prog.hidden.paid_desc": "Iklan berbayar tamat apabila bajet habis. Jangkauan tidak kekal. Tiada cerita sebenar.",
    "prog.hidden.organic_list_label": "Apa yang tuan-tuan terima secara organik:",
    "prog.hidden.paid_negative_prefix": "−RM",
    "prog.hidden.organic_positive_prefix": "+RM",
  },
  en: {
    // Nav
    ...
    "pkg.4.note": "Not just sponsorship. Lasting human capital development for your technical and creative team.",
    "pkg.4.intro": "8–12 weeks full journey. Five elements. One official named cohort.",
    "pkg.4.section1.label": "5 Program Elements",
    ...
    "pkg.4.section2.label": "What You Bring Home",
    "pkg.4.f7": "Official named cohort (Waris [Company] 2026)",
    "pkg.4.f8": "Training module to bring back for internal training",
    "pkg.4.f9": "Complete program report (participants, hours, certificates)",
    "pkg.4.f10": "Ready-to-use documentation (photos + video per session)",
    "pkg.4.f11": "Permanent IP credit on training module",
    "pkg.4.f12": "Official participation certificate per participant",
    "pkg.4.f13": "Tax deduction eligibility (Paragraph 34(6)(k))",
    "pkg.4.stats.hours": "96–120 training hours",
    "pkg.4.stats.students": "20–30 selected participants",
    "pkg.4.stats.weeks": "8–12 week program",
    ...
    "prog.journey.next": "Next Step →",
    "prog.journey.deliverable_label": "Deliverable:",
    "prog.board.click_hint": "← Click any card above to view details",
    "prog.board.empty_hint": "← Click any card above to view details",
    "prog.calc.tier_prefix": "Package",
    "prog.hidden.paid_desc": "Paid ads end when budget runs out. Reach doesn't last. No real stories.",
    "prog.hidden.organic_list_label": "What you receive organically:",
    "prog.hidden.paid_negative_prefix": "−RM",
    "prog.hidden.organic_positive_prefix": "+RM",
  },
};
