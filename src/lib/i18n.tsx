...
const translations: Record<Language, TranslationDict> = {
  ms: {
    ...
    "pkg.4.f7": "Modul latihan boleh bawa balik untuk latihan dalaman",
    "pkg.4.f8": "Laporan program lengkap (bilangan peserta, jam, sijil)",
    "pkg.4.f9": "Dokumentasi sedia guna (gambar + video setiap sesi)",
    "pkg.4.f10": "Kredit harta intelek kekal pada modul",
    "pkg.4.f11": "Sijil penyertaan rasmi setiap peserta",
    "pkg.4.f12": "Kelayakan potongan cukai (Perenggan 34(6)(k))",
  ...
  en: {
    ...
    "pkg.4.f7": "Training module to bring back for internal training",
    "pkg.4.f8": "Complete program report (participants, hours, certificates)",
    "pkg.4.f9": "Ready-to-use documentation (photos + video per session)",
    "pkg.4.f10": "Permanent IP credit on training module",
    "pkg.4.f11": "Official participation certificate per participant",
    "pkg.4.f12": "Tax deduction eligibility (Paragraph 34(6)(k))",
